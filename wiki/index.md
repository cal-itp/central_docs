...
<!-- GENERATED FILE — do not edit by hand. Run: node scripts/build-index.mjs -->
...
- [[gtfs-realtime-data-quality]] — Quality monitoring for GTFS Realtime data
- [[gtfs-rt-archiver]] — Pipeline archiving raw GTFS Realtime data to cloud storage; needs a formal SLA (#5109)
- [[gtfs-rt-parser]] — Airflow pipeline that parses and validates archived GTFS-RT protobuf into queryable warehouse data
- [[gtfs-schedule-data-quality]] — Quality monitoring for GTFS Schedule data
- [[gtfs-schedule-download-parse]] — Pipeline downloading and parsing GTFS Schedule feeds
...
### Services
_None yet — add services, tools, platforms here._

### Processes
_None yet — add workflows, intake queues, review processes here._

### Team Resources
_None yet — add environments, tooling, access groups here._

## Concepts
- [[data-governance-framework]] — Session 1: governance pillars, federal mandates, 4-phase roadmap
- [[data-product-lifecycle]] — 8-stage lifecycle for operationalizing governance through product management

## Comparisons
_None yet — add cross-entity comparisons here._
