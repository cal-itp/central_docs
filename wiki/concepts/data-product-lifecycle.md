...
summary: 8-stage lifecycle for operationalizing governance through product management
created: 2026-05-20
updated: 2026-05-20
type: concept
subtype: framework
...
5. **Quality as Build-Time Evidence** — Schema, volume, freshness, business,
   ...
   See [[dbt-data-processing]] for a live example of what happens when this stage
   is skipped — tests disabled since October due to alert fatigue.
